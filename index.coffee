...
class BraidBase
	...
	getContainerClass: (field, additionalClasses) =>
		# Field Exists
	...
	@Model = ->
	#	Model Extend
	@Model.Extend = (modelName, modelFields, modelLabels, modelJoiValidators, modelCustomValidators) ->
		# New Class
		class NewModel extends BraidBase
			...
			fields: modelFields
			labels: modelLabels
			joiValidators: modelJoiValidators
			customValidators: modelCustomValidators
		# Return
		return NewModel
