...
(function() {
  ...
  BraidBase = (function() {
    ...
    function BraidBase() {
      ...
      this.getContainerClass = __bind(this.getContainerClass, this);
    ...
    BraidBase.prototype.getContainerClass = function(field, additionalClasses) {
      var classes;
    ...
    BraidBase.Model.Extend = function(modelName, modelFields, modelLabels, modelJoiValidators, modelCustomValidators) {
      ...
      NewModel = (function(_super) {
        ...
        function NewModel() {
          _ref = NewModel.__super__.constructor.apply(this, arguments);
          return _ref;
        }
...
/*
//@ sourceMappingURL=BraidBase.map
*/
